...
describe("onboarding-storage", () => {
  ...
  describe("isCompleted", () => {
    it("deve retornar true quando o onboarding estiver concluído", async () => {
      ...
      expect(AsyncStorage.getItem).toHaveBeenCalledWith("@planty_onboarding_storage_is_completed");
  ...
  describe("complete", () => {
    it("deve marcar o onboarding como concluído", async () => {
      ...
      expect(AsyncStorage.setItem).toHaveBeenCalledWith("@planty_onboarding_storage_is_completed", "true");
    });
  });
});
