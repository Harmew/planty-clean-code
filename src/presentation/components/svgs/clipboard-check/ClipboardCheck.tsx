...
import type { ClipboardCheckProps } from "./types";

export function ClipboardCheck({ size = 24, color = "green500", ...props }: Readonly<ClipboardCheckProps>) {
  const { theme } = useAppTheme();

  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props} testID="clipboard-check-svg">
      <Path
